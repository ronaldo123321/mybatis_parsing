...
public class MapperBuilderAssistant extends BaseBuilder {
  ...
  public ResultMap addResultMap(
      ...
      Boolean autoMapping) {
    //1.获得ResultMap编号，即 ‘${namespace}.${id}’
    id = applyCurrentNamespace(id, false);
    //2.获取完整的extend属性，即`${namespace}.${extend}`。
    extend = applyCurrentNamespace(extend, true);
    //若有父类，则将父类对应的ResultMap集合，添加到resultMap中。
    if (extend != null) {
      //获得extend对应的ResultMap对象
      ...
      //判断如果当前的resultMappings是否有构造方法，如果有，则从extendedResultMappings移除所有构造类型的ResultMappings
  ...
  public MappedStatement addMappedStatement(
    ...
    MappedStatement.Builder statementBuilder = new MappedStatement.Builder(configuration, id, sqlSource, sqlCommandType)
        ...
        .cache(currentCache);
    //获得ParamterMap，并设置到MappedStatement.Builder中
