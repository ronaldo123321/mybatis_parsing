...
public class XPathParser {
  ...
  public XNode evalNode(String expression) { //返回XNode对象
    return evalNode(document, expression);
  }

  public XNode evalNode(Object root, String expression) { //XNode对象
    //1.获得Node对象
  ...
  private Document createDocument(InputSource inputSource) {
    ...
    try {
      ...
      builder.setErrorHandler(new ErrorHandler() {//实现都空着
        @Override
