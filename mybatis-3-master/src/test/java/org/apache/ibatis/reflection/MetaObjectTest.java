...
class MetaObjectTest {
  ...
  @Test
  void mytestMetaObject(){
    RichType richType = new RichType();
    MetaObject metaObject = SystemMetaObject.forObject(richType);
    metaObject.setValue("richType.richType.richField","hhj");
    assertEquals("hhj",metaObject.getValue("richType.richType.richField"));
  }
  ...
  void test01(){
    ...
    Class<?> type = metaObject.getObjectWrapper().getGetterType("richType.richMap.nihao");
